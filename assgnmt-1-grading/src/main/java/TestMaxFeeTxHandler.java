...
public class TestMaxFeeTxHandler {
    ...
    public static int test1(UTXOPool uPool) throws FileNotFoundException, IOException {
        ...
        Transaction[] allTxs1 = TransactionsArrayFileHandler.readTransactionsFromFile(getFileFromClasspath(file1));
        Transaction[] allTxs2 = TransactionsArrayFileHandler.readTransactionsFromFile(getFileFromClasspath(file2));
        Transaction[] allTxs3 = TransactionsArrayFileHandler.readTransactionsFromFile(getFileFromClasspath(file3));

        return UtilCOS.printPassFail(verify(allTxs1, allTxs2, allTxs3, uPool));
    }

    public static String getFileFromClasspath(String file) {
        URL fileUrl = TestMaxFeeTxHandler.class.getResource(file);
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        SampleKeyPairs skp = SampleKeyPairsFileHandler.readKeyPairsFromFile(getFileFromClasspath(skpFile));
        SampleUTXOPool sup = SampleUTXOPoolFileHandler.readSampleUTXOPoolFromFile(skp, getFileFromClasspath(supFile));
